...
mkdir /boot/EFI
mount /dev/sda2 /boot/EFI/  # use fdisk -l to see which partition on the USB disk is the EFI System
...
# Power management
vim /etc/default/grub
  GRUM_CMDLINE_LINUX_DEFAULT="loglevel=3 quiet mem_sleep_default=deep"
grub-mkconfig -o /boot/grub/grub.cfg
